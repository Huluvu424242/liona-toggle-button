...
describe('liona-toggle-button', () => {

  it('toggeld ist initial auf false gesetzt', async () => {
    const el = await fixture(html `<liona-toggle-button options='{ "content": "test", "toggledContent": "blup"}'>leer</liona-toggle-button>`);
    expect(el.toggled).to.be.false;
  });

  it('Der Button wird initial mit dem content label beschriftet', async () => {
    const el = /** @type {ToggleButton} */ await fixture(html `<liona-toggle-button options='{"content": "click here to toggle", "toggledContent": "click here to untoggle"}'>leer</liona-toggle-button>`);
  ...
  it('Der Button wird initial mit dem content label beschriftet, auch wenn toggled explizit mit false angegeben wurde', async () => {
    const el = /** @type {ToggleButton} */ await fixture(html `<liona-toggle-button toggled="false" options='{"content": "click here to toggle", "toggledContent": "click here to untoggle"}'>leer</liona-toggle-button>`);
    expect(el).shadowDom.to.equal('<button id="toggleButton" toggled="false">click here to toggle</button>');
  });
  ...
  it('Der Button wird initial mit dem toggledContent label beschriftet wenn toggled explizit mit true angegeben wurde.', async () => {
    const el = /** @type {ToggleButton} */ await fixture(html `<liona-toggle-button toggled="true" options='{"content": "click here to toggle", "toggledContent": "click here to untoggle"}'>leer</liona-toggle-button>`);
